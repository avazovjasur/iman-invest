    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.startWrapper}>
        <div className={styles.startContent}>
            ...
            <div className={styles.valueTop}>
              ...
              <button className={styles.valueTopBtn}>
                ...
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4.2002 10.2852L7.7788 6.70655C8.16933 6.31603 8.16933 5.68286 7.7788 5.29234L4.2002 1.71373" stroke="#3680FF" stroke-linecap="round" />
                </svg>
              </button>
            </div>
              ...
              <li className={styles.mainListItem}>
                <div className={styles.mainListItemImg}>
                  <div className={styles.mainListItemBox}>
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M11 6.00488C11 8.76488 8.76 11.0049 6 11.0049C3.24 11.0049 1 8.76488 1 6.00488C1 3.24488 3.24 1.00488 6 1.00488C8.76 1.00488 11 3.24488 11 6.00488Z" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M7.85543 7.59477L6.30543 6.66977C6.03543 6.50977 5.81543 6.12477 5.81543 5.80977V3.75977" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <h3>3 мин</h3>
                  </div>
                </div>
          ...
          <div className={styles.value}>
            ...
            <div className={styles.startBody}>
              ...
              <button className={styles.topButton}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_4977_9763)">
                ...
                <div className={styles.mainListItemImg}>
                  <div className={`${styles.mainListItemBox} ${styles.second}`}>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M6.99696 2.78104C7.39944 1.93757 8.60006 1.93757 9.00254 2.78104L10.2377 5.36949L13.0811 5.74431C14.0077 5.86645 14.3787 7.00831 13.7009 7.65174L11.6208 9.62631L12.143 12.4464C12.3132 13.3654 11.3419 14.0711 10.5205 13.6253L7.99975 12.2572L5.47904 13.6253C4.65764 14.0711 3.68632 13.3654 3.85648 12.4464L4.37868 9.62632L2.2986 7.65174C1.62078 7.00831 1.9918 5.86645 2.91836 5.74431L5.76181 5.36949L6.99696 2.78104ZM7.99975 3.77555L6.91322 6.05256C6.75124 6.39201 6.42853 6.62648 6.05563 6.67563L3.55432 7.00535L5.38412 8.74234C5.6569 9.00128 5.78017 9.38066 5.71169 9.75049L5.25232 12.2313L7.46973 11.0278C7.8003 10.8484 8.1992 10.8484 8.52977 11.0278L10.7472 12.2313L10.2878 9.75049C10.2193 9.38066 10.3426 9.00129 10.6154 8.74234L12.4452 7.00535L9.94387 6.67563C9.57097 6.62648 9.24826 6.39201 9.08628 6.05256L7.99975 3.77555Z" fill="#FFBB38" />
                    </svg>
                    <h3>10 очков</h3>
                  </div>
                </div>
          ...
          <button className={styles.startButton}>Не знаю с чего начать</button>
  ...
  return (
    <li className={styles.faqListItem}>
      <div className={styles.faqListItemTop} onClick={toggleContent}>
        <h3>{title}</h3>
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1.71484 4.29004L5.29345 7.86865C5.68398 8.25917 6.31714 8.25917 6.70766 7.86865L10.2863 4.29004" stroke="#040415" stroke-linecap="round" />
        </svg>
      </div>
      <div ref={contentRef}
