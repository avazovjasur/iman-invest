...
const HomeInner = () => {
  ...
  const investmentsAmount = useSelector((state) => state.otp.investments_amount);
  ...
  return <>
    <div className={styles.top}>
      ...
      <div className={styles.content}>
        ...
        <h3 className={styles.contentBalance}>
          {formatNumber(investmentsAmount)} сум
        </h3>
        <div className={styles.contentProfit}>
          ...
          <h3 className={styles.contentProfitTitle}>
            + {formatNumber(investmentsProfit)} сум
          </h3>
        </div>
    ...
    <div className={styles.goal}>
      ...
      {investments && investments.length < 0 && <div className={styles.goalEmpty}>
              ...
              <Link key={index} href={`/aim/${el.guid}`}>
                <li className={styles.goalListItem}>
                  <div className={styles.goalListItemHeader}>
                    ...
                    <div className={styles.goalItemFeaturesCurrency}>
                      Сумовый
                    </div>
                  </div>
                  <div className={styles.goalListItemAmount}>
                    <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                          d="M4.94108 10.6372L5.05653 1.63799M5.05653 1.63799L1.01196 5.08639M5.05653 1.63799L9.0113 5.18901"
                          stroke="#117C3A"
                          stroke-width="1.6"
                  ...
                  <div className={styles.goalListItemStatistics}>
                    ...
                    <span>{formatNumber(el.investment_amount)}</span>
                    <span className={styles.goalListItemIncome}>+ {formatNumber(el.last_month_profit.amount)} сум</span>
                  </div>
