        ...
        <div className={styles.modal}>
          <div className={styles.modalWrapper}>
            <div className={styles.modalClose}>
              <button
                className={`${styles.modalCloseBtn} ${step === 3 ? styles.active : ''}`}
                onClick={handleSkip}
              >
                Пропустить
              </button>
            ...
            {step === 3 && (
              <div className={styles.modalStepThree}>
                ...
                <div className={styles.stepTwoContent}>
                  <h2 className={styles.stepTitle}>Начните уже сейчас</h2>
                  <p className={styles.stepText}>
                    Чтобы начать копить, нужно только выбрать цель и срок
                  </p>
                </div>
              </div>
            )}
